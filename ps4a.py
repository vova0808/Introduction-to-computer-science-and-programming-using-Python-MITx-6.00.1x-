...
def playGame(wordList):
    ...
    while True:
        ...
        #if user choose to play a new game, make a new hand, save this hand is hands list and start the game
        if user_input == "n":            
            hand = dealHand(HAND_SIZE)
            hands.append(hand)
            playHand(hand, wordList, HAND_SIZE)
        # if user choose to play a previous version of the hand, check if this hand in hands list and play a new game, otherwise displey a warning message    
        elif user_input == "r":
            if len(hands) == 0:
                print("You have not played a hand yet. Please a play a new hand first")
                print("")
            else:
